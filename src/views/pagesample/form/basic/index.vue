        ...
        <el-col :xs="24" :sm="20" :md="16" :lg="12" :xl="12">
          <el-form :model="modelRef" :rules="rulesRef" ref="formRef" label-width="100px">
            ...
            <el-form-item label="起止日期" prop="date">
              <el-date-picker type="daterange" v-model="modelRef.date" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" class="form-basic-width100">
              </el-date-picker>
            </el-form-item>
            ...
            <el-form-item label="备注" prop="remark">
              <el-input type="textarea" :autosize="{ minRows: 2, maxRows: 4}" placeholder="请输入内容" v-model="modelRef.remark">
              </el-input>
            </el-form-item>
